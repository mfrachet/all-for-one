...
export const computeOutputPrompt = (input: string) => {
  return `
   You have to provide an output that matches the ExpectedOutput type from the following TypeScript type definition. The output should be in JSON without escaping characters nor new lines.
